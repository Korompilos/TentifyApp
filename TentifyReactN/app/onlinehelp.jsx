...
const onlinehelp = () => {
  ...
  const modalData = [
    ...
    {
      id: 7, buttonText: 'Activities', header: 'PARTICIPATE IN OUR AVAILABLE ACTIVITIES', content: 'By pressing the special button on the TabBar, you will be redirected to the available activities. Depending on the date, you will be presented with all the activities that are scheduled in the near future. These can be group or non-group and you declare participation by pressing the "Partcipate" button under the corresponding activity. After a while you will know if your application was approved by the button text.'   },
    { id: 8, buttonText: 'Finding Shelter', header: 'IF THE WEATHER IS UNSTABLE, MOVE TO A SHELTER', content: 'After watching the weather and realizing that bad weather is coming (or already underway), you should move to the nearest shelter. Pressing the corresponding button from the TabBar will take you to the shelter finding page. There you will be presented with a map showing where you have pitched your tent and available shelters. If bad weather is coming, by pressing the button "Find Shelter" you will be offered via the map the route to the nearest shelter. As long as it is not in progress or bad weather is coming, you will be shown a relevant message.'}
  ];
